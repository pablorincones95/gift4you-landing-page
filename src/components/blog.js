  ...
  render() {
  	...
  	return (
         ...
         <div className="about-decor">
            <div className="about-circle1"><img className="team1-img"  src="assets/images/team1.png" alt="" /></div>
            <div className="about-circle2"><img className="main-banner-img" src="assets/images/main-banner1.png" alt="" /></div>
         </div>
