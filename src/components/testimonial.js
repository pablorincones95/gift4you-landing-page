  	...
  	return (
  		<section id="testimonial" className="testimonial">
           <div className="testimonial-decor">
              <div className="testi-circle1"><img className="testimonial2" src="assets/images/regalo-fucsia.png" alt="regalo fucsia" /></div>
              <div className="testi-circle2"><img className="testimonial1" src="assets/images/tres-regalos.png" alt="tres regalos" /></div>
           </div>
