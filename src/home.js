			         ...
			         <div className="col-md-5 col-sm-12">
			            <div className="home-contain">
			               <div className="text-white">
			                  ...
			                  <img className="logo-icon" src="assets/images/home2/logo-icon.png" alt="logo" />
			                  ...
			                  <p className="slide-cap-desc">Descarga la nueva app Gift4You, la unica encargada de llevar tus sentimientos como si fuesen propios. Expresa sin palabras.</p>
